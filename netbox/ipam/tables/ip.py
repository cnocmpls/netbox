...
class PrefixTable(TenancyColumnsMixin, NetBoxTable):
    ...
    area_network = columns.ChoiceFieldColumn(
    ...
    class Meta(NetBoxTable.Meta):
        ...
        fields = (
            ...
            'region', 'site', 'vlan_group', 'vlan', 'role', 'is_pool', 'mark_utilized', 'description', 'area_network', 'comments', 'tags',
            'created', 'last_updated',
        )
        default_columns = (
            'pk', 'prefix', 'status', 'children', 'vrf', 'utilization', 'tenant','region', 'site', 'vlan', 'role', 'description', 'area_network',
        )
        row_attrs = {
...
class IPAddressTable(TenancyColumnsMixin, NetBoxTable):
    ...
    class Meta(NetBoxTable.Meta):
        model = IPAddress
        fields = (
            'pk', 'id', 'address', 'vrf','region', 'site_group', 'status', 'role', 'tenant', 'tenant_group', 'nat_inside', 'nat_outside',
...
class IPAddressAssignTable(NetBoxTable):
    ...
    class Meta(NetBoxTable.Meta):
        model = IPAddress
        fields = ('address', 'dns_name', 'vrf','region', 'site_group', 'status', 'role', 'tenant', 'assigned_object', 'description')
        exclude = ('id', )
        orderable = False
...
# class IPAM_RegionTable(NetBoxTable):
#     name = tables.Column(
#         verbose_name=_('Name'),
#         linkify=True
#     )
...
#     )
#     tags = columns.TagColumn(
#         url_name='ipam:ipam_region_list'
#     )

#     class Meta(NetBoxTable.Meta):
#         model = IPAM_Region
#         fields = (
#             'pk', 'id', 'name', 'slug', 'prefix_count', 'iprange_count', 'description', 'weight', 'tags',
#             'created', 'last_updated', 'actions',
#         )
#         default_columns = ('pk', 'name', 'prefix_count', 'iprange_count', 'description')
...
#         linkify=True
#     )
#     ipam_region = tables.Column(
#         verbose_name=_('IPAM_Region'),
#         linkify=True
#     )
#     is_pool = columns.BooleanColumn(
#         verbose_name=_('Pool')
...
#         fields = (
#             'pk', 'id', 'prefix', 'prefix_flat', 'status', 'children', 'vrf', 'utilization', 'tenant', 'tenant_group',
#             'site', 'vlan_group', 'vlan', 'role','ipam_region', 'is_pool', 'mark_utilized', 'description', 'comments', 'tags',
#             'created', 'last_updated',
#         )
#         default_columns = (
#             'pk', 'prefix', 'status', 'children', 'vrf', 'utilization', 'tenant', 'site', 'vlan', 'role', 'ipam_region', 'description',
#         )
#         row_attrs = {
#             'class': lambda record: 'success' if not record.pk else '',
#         }
...
#         model = IPRange
#         fields = (
#             'pk', 'id', 'start_address', 'end_address', 'size', 'vrf', 'status', 'role', 'ipam_region', 'tenant', 'tenant_group',
#             'mark_utilized', 'utilization', 'description', 'comments', 'tags', 'created', 'last_updated',
#         )
#         default_columns = (
#             'pk', 'start_address', 'end_address', 'size', 'vrf', 'status', 'role', 'ipam_region', 'tenant', 'description',
#         )
#         row_attrs = {
#             'class': lambda record: 'success' if not record.pk else '',
#         }
...
#         model = IPAddress
#         fields = (
#             'pk', 'id', 'address', 'vrf', 'status', 'role', 'ipam_region', 'tenant', 'tenant_group', 'nat_inside', 'nat_outside',
#             'assigned', 'dns_name', 'description', 'comments', 'tags', 'created', 'last_updated',
#         )
#         default_columns = (
#             'pk', 'address', 'vrf', 'status', 'role', 'ipam_region', 'tenant', 'assigned', 'dns_name', 'description',
#         )
#         row_attrs = {
#             'class': lambda record: 'success' if not isinstance(record, IPAddress) else '',
#         }
...
#     class Meta(NetBoxTable.Meta):
#         model = IPAddress
#         fields = ('address', 'dns_name', 'vrf', 'status', 'role', 'ipam_region', 'tenant', 'assigned_object', 'description')
#         exclude = ('id', )
#         orderable = False
...
#     class Meta(NetBoxTable.Meta):
#         model = IPAddress
#         fields = ('address', 'vrf', 'status', 'role', 'ipam_region', 'tenant', 'description')
#         exclude = ('id', )
