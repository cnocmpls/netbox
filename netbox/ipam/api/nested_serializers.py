...
#     exclude_fields=('prefix_count'),
# )
# class NestedIPAM_RegionSerializer(WritableNestedSerializer):
#     url = serializers.HyperlinkedIdentityField(view_name='ipam-api:ipam_region-detail')
#     prefix_count = serializers.IntegerField(read_only=True)

#     class Meta:
#         model = models.IPAM_Region
#         fields = ['id', 'url', 'display', 'name', 'slug', 'prefix_count']
