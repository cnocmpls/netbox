...
# class IPAM_RegionViewSet(NetBoxModelViewSet):
#     queryset = IPAM_Region.objects.annotate(
#         prefix_count=count_related(Prefix, 'ipam_region'),
#         vlan_count=count_related(VLAN, 'ipam_region')
#     ).prefetch_related('tags')
#     serializer_class = serializers.IPAM_RegionRegionSerializer
#     filterset_class = filtersets.IPAM_RegionFilterSet

# class PrefixViewSet(NetBoxModelViewSet):
#     queryset = Prefix.objects.prefetch_related(
#         'site', 'vrf__tenant', 'tenant', 'vlan', 'role', 'ipam_region', 'tags'
#     )
#     serializer_class = serializers.PrefixSerializer
#     filterset_class = filtersets.PrefixFilterSet
...
# class IPRangeViewSet(NetBoxModelViewSet):
#     queryset = IPRange.objects.prefetch_related('vrf', 'role','ipam_region', 'tenant', 'tags')
#     serializer_class = serializers.IPRangeSerializer
#     filterset_class = filtersets.IPRangeFilterSet
