...
from dcim.api.nested_serializers import NestedDeviceSerializer, NestedSiteSerializer , NestedRegionSerializer, NestedSiteGroupSerializer
...
class PrefixSerializer(NetBoxModelSerializer):
    ...
    prefix = IPNetworkField()
    area_network = ChoiceField(choices=PrefixAreaNetworkChoices, required=False)

    class Meta:
        model = Prefix
        fields = [
            'id', 'url', 'display', 'family', 'prefix', 'region', 'site', 'vrf', 'tenant', 'vlan', 'status', 'role', 'is_pool',
            'mark_utilized', 'description', 'area_network', 'comments', 'tags', 'custom_fields', 'created', 'last_updated', 
            'children','_depth',
        ]
...
class IPAddressSerializer(NetBoxModelSerializer):
    ...
    vrf = NestedVRFSerializer(required=False, allow_null=True)
    region = NestedRegionSerializer(required=False, allow_null=True)
    site_group = NestedSiteGroupSerializer(required=False, allow_null=True)
    tenant = NestedTenantSerializer(required=False, allow_null=True)
    ...
    class Meta:
        model = IPAddress
        fields = [
            'id', 'url', 'display', 'family', 'address', 'vrf', 'region', 'site_group', 'tenant', 'status', 'role', 'assigned_object_type',
...
# class IPAM_RegionSerializer(NetBoxModelSerializer):
#     url = serializers.HyperlinkedIdentityField(view_name='ipam-api:ipam_region-detail')
#     prefix_count = serializers.IntegerField(read_only=True)
...
#     status = ChoiceField(choices=PrefixStatusChoices, required=False)
#     role = NestedRoleSerializer(required=False, allow_null=True)
#     ipam_region = NestedIPAM_RegionSerializer(required=False, allow_null=True)
#     children = serializers.IntegerField(read_only=True)
#     _depth = serializers.IntegerField(read_only=True)
#     prefix = IPNetworkField()
...
#         model = Prefix
#         fields = [
#             'id', 'url', 'display', 'family', 'prefix', 'site', 'vrf', 'tenant', 'vlan', 'status', 'role', 'ipam_region','is_pool',
...
#         model = IPRange
#         fields = [
#             'id', 'url', 'display', 'family', 'start_address', 'end_address', 'size', 'vrf', 'tenant', 'status', 'role', 'ipam_region',
#             'description', 'comments', 'tags', 'custom_fields', 'created', 'last_updated',
#             'mark_utilized', 'description', 'comments', 'tags', 'custom_fields', 'created', 'last_updated',
#         ]
...
#         model = IPAddress
#         fields = [
#             'id', 'url', 'display', 'family', 'address', 'vrf', 'tenant', 'status', 'role', 'ipam_region', 'assigned_object_type',
#             'assigned_object_id', 'assigned_object', 'nat_inside', 'nat_outside', 'dns_name', 'description', 'comments',
#             'tags', 'custom_fields', 'created', 'last_updated',
#         ]
