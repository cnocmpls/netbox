...
class IPAMQuery(graphene.ObjectType):
    ...
    # ipam_region = ObjectField(IPAM_RegionType)
    # ipam_region_list = ObjectListField(IPAM_RegionType)

    # def resolve_ipam_region_list(root, info, **kwargs):
    #     return gql_query_optimizer(models.IPAM_Region.objects.all(), info)
