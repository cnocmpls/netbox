...
class PrefixAreaNetworkChoices(ChoiceSet):
    key = 'Prefix.area_network'
    

    AREA_NETWORK_LAN = 'lan'
    AREA_NETWORK_WAN = 'wan'


    CHOICES = [

        (AREA_NETWORK_LAN, _('LAN'), 'blue'),
        (AREA_NETWORK_WAN, _('WAN'), 'red'),    
    ]
...
class IPAddressRoleChoices(ChoiceSet):
    ...
    CHOICES = (
        ...
        (ROLE_BACKBONE, _('Backbone'), 'green'),
