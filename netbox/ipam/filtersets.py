...
class PrefixFilterSet(NetBoxModelFilterSet, TenancyFilterSet):
    ...
    area_network = django_filters.MultipleChoiceFilter(
...
# class IPAM_RegionFilterSet(OrganizationalModelFilterSet):
...
#     ipam_region_id = django_filters.ModelMultipleChoiceFilter(
#         queryset=IPAM_Region.objects.all(),
#         label=_('IPAM_Region (ID)'),
#     )
#     ipam_region = django_filters.ModelMultipleChoiceFilter(
#         field_name='ipam_region__slug',
#         queryset=IPAM_Region.objects.all(),
#         to_field_name='slug',
#         label=_('IPAM_Region (slug)'),
#     )
#     status = django_filters.MultipleChoiceFilter(
#         choices=PrefixStatusChoices,
#         null_value=None
...
#         choices=IPAddressRoleChoices
#     )
#     ipam_region = django_filters.MultipleChoiceFilter(
#         field_name='region',
#         queryset=IPAM_Region.objects.all(),
#         label=_('IPAM_Region (ID)'),
#     )
