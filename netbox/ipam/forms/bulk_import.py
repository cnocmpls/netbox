...
from dcim.models import Device, Interface, Site, Region, SiteGroup
...
class PrefixImportForm(NetBoxModelImportForm):
    ...
    area_network = CSVChoiceField(
        label=_('Area network'),
        choices=PrefixAreaNetworkChoices,
        required=False,
        help_text=_('Area network')
    )

    class Meta:
        model = Prefix
        fields = (
            'prefix', 'vrf', 'tenant', 'region', 'site', 'vlan_group', 'vlan', 'status', 'role', 'is_pool', 'mark_utilized',
...
class IPAddressImportForm(NetBoxModelImportForm):
    ...
    site_group = CSVModelChoiceField(
        label=_('Site group/Territory'),
        queryset=SiteGroup.objects.all(),
        to_field_name='name',
        required=False,
        help_text=_('Assigned site group/territory')
    )
    tenant = CSVModelChoiceField(
        label=_('Tenant'),
        queryset=Tenant.objects.all(),
    ...
    class Meta:
        model = IPAddress
        fields = [
            'address', 'vrf','region', 'site_group', 'tenant', 'status', 'role', 'device', 'virtual_machine', 'interface', 'is_primary',
...
# class IPAM_RegionImportForm(NetBoxModelImportForm):
#     slug = SlugField()
...
#         help_text=_('Functional role')
#     )
#     ipam_region = CSVModelChoiceField(
#         label=_('IPAM_Region'),
...
#         model = Prefix
#         fields = (
#             'prefix', 'vrf', 'tenant', 'site', 'vlan_group', 'vlan', 'status', 'role', 'ipam_region', 'is_pool', 'mark_utilized',
#             'description', 'comments', 'tags',
#         )
...
#         model = IPRange
#         fields = (
#             'start_address', 'end_address', 'vrf', 'tenant', 'status', 'role', 'ipam_region', 'mark_utilized', 'description',
#             'comments', 'tags',
#         )
...
#         model = IPAddress
#         fields = [
#             'address', 'vrf', 'tenant', 'status', 'role', 'ipam_region', 'device', 'virtual_machine', 'interface', 'is_primary',
#             'dns_name', 'description', 'comments', 'tags',
#         ]
