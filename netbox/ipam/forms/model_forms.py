...
class PrefixForm(TenancyForm, NetBoxModelForm):
    ...
    fieldsets = (
        (_('Prefix'), ('prefix', 'status', 'vrf', 'role', 'is_pool', 'mark_utilized', 'description', 'area_network', 'tags')),
        (_('Site/VLAN Assignment'), ('region', 'site', 'vlan')),
        (_('Tenancy'), ('tenant_group', 'tenant')),
    )
    ...
    class Meta:
        model = Prefix
        fields = [
            'prefix', 'vrf', 'region', 'site', 'vlan', 'status', 'role', 'is_pool', 'mark_utilized', 'tenant_group', 'tenant',
            'description', 'area_network', 'comments', 'tags',
        ]
...
class IPAddressForm(TenancyForm, NetBoxModelForm):
    ...
    class Meta:
        model = IPAddress
        fields = [
            'address', 'vrf', 'region', 'site_group', 'status', 'role', 'dns_name', 'primary_for_parent', 'nat_inside', 'tenant_group',
...
class IPAddressBulkAddForm(TenancyForm, NetBoxModelForm):
    ...
    class Meta:
        model = IPAddress
        fields = [
            'address', 'vrf','region', 'site_group', 'status', 'role', 'dns_name', 'description', 'tenant_group', 'tenant', 'tags',
        ]
...
# class IPAM_RegionForm(NetBoxModelForm):
#     slug = SlugField()
...
#         required=False
#     )
#     ipam_region = DynamicModelChoiceField(
#         label=_('IPAM_Region'),
...
#     fieldsets = (
#         (_('Prefix'), ('prefix', 'status', 'vrf', 'role', 'ipam_region', 'is_pool', 'mark_utilized', 'description', 'tags')),
...
#         model = Prefix
#         fields = [
#             'prefix', 'vrf', 'site', 'vlan', 'status', 'role', 'ipam_region', 'is_pool', 'mark_utilized', 'tenant_group', 'tenant',
#             'description', 'comments', 'tags',
#         ]
...
#     fieldsets = (
#         (_('IP Range'), ('vrf', 'start_address', 'end_address', 'role', 'ipam_region', 'status', 'mark_utilized', 'description', 'tags')),
#         (_('Tenancy'), ('tenant_group', 'tenant')),
#     )
...
#         model = IPRange
#         fields = [
#             'vrf', 'start_address', 'end_address', 'status', 'role', 'ipam_region', 'tenant_group', 'tenant', 'mark_utilized',
#             'description', 'comments', 'tags',
#         ]
...
#         model = IPAddress
#         fields = [
#             'address', 'vrf', 'status', 'role', 'ipam_region ', 'dns_name', 'primary_for_parent', 'nat_inside', 'tenant_group',
#             'tenant', 'description', 'comments', 'tags',
#         ]
...
#         model = IPAddress
#         fields = [
#             'address', 'vrf', 'status', 'role', 'ipam_region ', 'dns_name', 'description', 'tenant_group', 'tenant', 'tags',
#         ]
