...
class PrefixFilterForm(TenancyFilterForm, NetBoxModelFilterSetForm):
    ...
    fieldsets = (
        (None, ('q', 'filter_id', 'tag')),
        (_('Addressing'), ('within_include', 'family', 'status', 'role_id', 'mask_length', 'is_pool', 'area_network', 'mark_utilized')),
        (_('VRF'), ('vrf_id', 'present_in_vrf_id')),
        (_('Location'), ( 'site_group_id', 'site_id')),
        (_('Region'), ('region_id',)),
        (_('Tenant'), ('tenant_group_id', 'tenant_id')),
    )
    ...
    area_network = forms.MultipleChoiceField(
        required=False,
...
class IPAddressFilterForm(TenancyFilterForm, NetBoxModelFilterSetForm):
    ...
    fieldsets = (
        ...
        (_('VRF'), ('vrf_id', 'present_in_vrf_id')),
        (_('Region'), ('region_id','site_group_id')),
        (_('Tenant'), ('tenant_group_id', 'tenant_id')),
...
# class IPAM_RegionFilterForm(NetBoxModelFilterSetForm):
#     model = IPAM_Region
#     tag = TagFilterField(model)
...
#     fieldsets = (
#         (None, ('q', 'filter_id', 'tag')),
#         (_('Addressing'), ('within_include', 'family', 'status', 'role_id', 'ipam_region_id', 'mask_length', 'is_pool', 'mark_utilized')),
#         (_('VRF'), ('vrf_id', 'present_in_vrf_id')),
#         (_('Location'), ('region_id', 'site_group_id', 'site_id')),
#         (_('Tenant'), ('tenant_group_id', 'tenant_id')),
#     )
...
#         label=_('Role')
#     )
#     ipam_region_id = DynamicModelChoiceField(
...
#     fieldsets = (
#         (None, ('q', 'filter_id', 'tag')),
#         (_('Attributes'), ('family', 'vrf_id', 'status', 'role_id', 'ipam_region_id', 'mark_utilized')),
#         (_('Tenant'), ('tenant_group_id', 'tenant_id')),
#     )
#     family = forms.ChoiceField(
#         required=False,
...
#         label=_('Role')
#     )
#     ipam_region_id = DynamicModelMultipleChoiceField(
#         queryset=IPAM_Region.objects.all(),
#         required=False,
#         null_option='None',
#         label=_('IPAM Region')
...
#     fieldsets = (
#         (None, ('q', 'filter_id', 'tag')),
#         (_('Attributes'), ('parent', 'family', 'status', 'role', 'ipam_region_id', 'mask_length', 'assigned_to_interface', 'dns_name')),
#         (_('VRF'), ('vrf_id', 'present_in_vrf_id')),
#         (_('Tenant'), ('tenant_group_id', 'tenant_id')),
#         (_('Device/VM'), ('device_id', 'virtual_machine_id')),
#     )
...
#         required=False
#     )
#     ipam_region = DynamicModelMultipleChoiceField(
#         queryset=IPAM_Region.objects.all(),
#         required=False,
#         null_option='None',
#         label=_('IPAM Region')
