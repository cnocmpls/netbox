...
class PrefixBulkEditForm(NetBoxModelBulkEditForm):
    ...
    area_network = forms.ChoiceField(
        label=_('Area network'),
        choices=add_blank_choice(PrefixAreaNetworkChoices),
        required=False
    )
    comments = CommentField()
    ...
    model = Prefix
    fieldsets = (
        (None, ('tenant', 'status', 'role', 'description', 'area_network')),
        (_('Site'), ('region', 'site_group', 'site')),
        (_('Addressing'), ('vrf', 'prefix_length', 'is_pool', 'mark_utilized')),
    )
    nullable_fields = (
        'site', 'vrf', 'tenant', 'role', 'description', 'comments' 'area_network',
    )
...
class IPAddressBulkEditForm(NetBoxModelBulkEditForm):
    ...
    model = IPAddress
    fieldsets = (
        (None, ('status', 'role','region', 'site_group', 'tenant', 'description')),
...
# class IPAM_RegionBulkEditForm(NetBoxModelBulkEditForm):
#     weight = forms.IntegerField(
#         label=_('Weight'),
#         required=False
#     )
...
#     model = Prefix
#     fieldsets = (
#         (None, ('tenant', 'status', 'role', 'ipam_region', 'description')),
#         (_('Site'), ('region', 'site_group', 'site')),
#         (_('Addressing'), ('vrf', 'prefix_length', 'is_pool', 'mark_utilized')),
#     )
#     nullable_fields = (
#         'site', 'vrf', 'tenant', 'role','ipam_region', 'description', 'comments',
#     )
...
#     model = IPRange
#     fieldsets = (
#         (None, ('status', 'role', 'ipam_region', 'vrf', 'tenant', 'mark_utilized', 'description')),
#     )
#     nullable_fields = (
#         'vrf', 'tenant', 'role', 'ipam_region', 'description', 'comments',
#     )
...
#     model = IPAddress
#     fieldsets = (
#         (None, ('status', 'role', 'ipam_region', 'tenant', 'description')),
#         (_('Addressing'), ('vrf', 'mask_length', 'dns_name')),
#     )
#     nullable_fields = (
#         'vrf', 'role', 'ipam_region', 'tenant', 'dns_name', 'description', 'comments',
#     )
